...
static void do_service(HttpResponse, Service_T);
...
static void do_foot(HttpResponse res)
{
        StringBuffer_append(res->outputbuffer,
                            "</center></div></div>"
                            "<div id='footer'>"
                            "Copyright &copy; 2001-2019 <a href=\"http://tildeslash.com/\">Tildeslash</a>. All rights reserved. "
...
static void do_about(HttpResponse res)
{
        ...
        StringBuffer_append(res->outputbuffer,
                            "<ul>"
                            "<li style='padding-bottom:10px;'>Copyright &copy; 2001-2019 <a "
...
static void do_service(HttpResponse res, Service_T s)
{
        char buf[STRLEN];
