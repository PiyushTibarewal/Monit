...
pkglibexecdir = $(libexecdir)/monit
...
CONFIG_CLEAN_FILES = system/startup/monit.upstart \
	system/startup/monit.service
CONFIG_CLEAN_VPATH_FILES =
am__installdirs = "$(DESTDIR)$(bindir)" "$(DESTDIR)$(man1dir)"
PROGRAMS = $(bin_PROGRAMS)
am__dirstamp = $(am__leading_dot)dirstamp
am_monit_OBJECTS = src/y.tab.$(OBJEXT) src/lex.yy.$(OBJEXT) \
	src/monit.$(OBJEXT) src/alert.$(OBJEXT) src/control.$(OBJEXT) \
	...
	src/net.$(OBJEXT) src/sha1.$(OBJEXT) src/signal.$(OBJEXT) \
	src/socket.$(OBJEXT) src/spawn.$(OBJEXT) src/state.$(OBJEXT) \
	src/util.$(OBJEXT) src/validate.$(OBJEXT) \
	src/device/device_common.$(OBJEXT) \
	src/device/sysdep_LINUX.$(OBJEXT) src/http/base64.$(OBJEXT) \
	src/http/cervlet.$(OBJEXT) src/http/client.$(OBJEXT) \
	src/http/engine.$(OBJEXT) src/http/xml.$(OBJEXT) \
	src/http/processor.$(OBJEXT) \
	src/notification/Address.$(OBJEXT) \
	src/notification/MMonit.$(OBJEXT) \
	src/notification/SMTP.$(OBJEXT) \
	src/process/ProcessTree.$(OBJEXT) \
	src/process/sysdep_LINUX.$(OBJEXT) \
	...
	src/protocols/fail2ban.$(OBJEXT) src/protocols/ftp.$(OBJEXT) \
	src/protocols/generic.$(OBJEXT) src/protocols/gps.$(OBJEXT) \
	...
	src/protocols/redis.$(OBJEXT) src/protocols/rsync.$(OBJEXT) \
	src/protocols/sieve.$(OBJEXT) src/protocols/sip.$(OBJEXT) \
	src/protocols/smtp.$(OBJEXT) \
	src/protocols/spamassassin.$(OBJEXT) \
	src/protocols/ssh.$(OBJEXT) src/protocols/tns.$(OBJEXT) \
	src/protocols/websocket.$(OBJEXT) src/ssl/Ssl.$(OBJEXT) \
	src/terminal/Box.$(OBJEXT) src/terminal/Color.$(OBJEXT)
monit_OBJECTS = $(am_monit_OBJECTS)
monit_DEPENDENCIES = libmonit/libmonit.la ulfius/src/libulfius.so \
	orcania/src/liborcania.so yder/src/libyder.so \
	jansson/src/libjansson.la
AM_V_lt = $(am__v_lt_$(V))
am__v_lt_ = $(am__v_lt_$(AM_DEFAULT_VERBOSITY))
am__v_lt_0 = --silent
am__v_lt_1 = 
monit_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(AM_CFLAGS) $(CFLAGS) \
	$(monit_LDFLAGS) $(LDFLAGS) -o $@
AM_V_P = $(am__v_P_$(V))
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(top_srcdir)/config/compile \
	...
	$(top_srcdir)/config/missing $(top_srcdir)/src/config.h.in \
	$(top_srcdir)/system/startup/monit.service.in \
	$(top_srcdir)/system/startup/monit.upstart.in COPYING README \
...
ACLOCAL = ${SHELL} /home/piyush/monit-5.25.3/config/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
ARCH = LINUX
AUTOCONF = ${SHELL} /home/piyush/monit-5.25.3/config/missing autoconf
AUTOHEADER = ${SHELL} /home/piyush/monit-5.25.3/config/missing autoheader
AUTOMAKE = ${SHELL} /home/piyush/monit-5.25.3/config/missing automake-1.15
AWK = mawk
CC = gcc
CCDEPMODE = depmode=none
CFLAGS = -Wno-address -Wno-pointer-sign -g -O2 -Wall -Wunused -Wno-unused-label -funsigned-char -D_GNU_SOURCE -std=c99 -D _REENTRANT -I/usr/include
CPP = gcc -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
...
LDFLAGS =  -rdynamic
LIBOBJS = 
LIBS = -lcrypto -lssl -lpam -lz -lpthread -lcrypt -lresolv -lnsl 
LIBTOOL = $(SHELL) $(top_builddir)/libtool
LIPO = 
LN_S = ln -s
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/piyush/monit-5.25.3/config/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
VERSION = 5.25.3
YACC = no
abs_builddir = /home/piyush/monit-5.25.3
abs_srcdir = /home/piyush/monit-5.25.3
abs_top_builddir = /home/piyush/monit-5.25.3
abs_top_srcdir = /home/piyush/monit-5.25.3
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/piyush/monit-5.25.3/config/install-sh
...
FLEXFLAGS = -i
YACCFLAGS = -dvt
AM_CPPFLAGS = $(CPPFLAGS) $(EXTCPPFLAGS)  -DLINUX -DSYSCONFDIR="\"${prefix}/etc\"" -I./src -I./src/device -I./src/http -I./src/notification -I./src/process -I./src/protocols -I./src/ssl -I./src/terminal  -I./ulfius/include -I./libmonit/src
...
monit_LDADD = libmonit/libmonit.la ulfius/src/libulfius.so orcania/src/liborcania.so yder/src/libyder.so jansson/src/libjansson.la
...
system/startup/monit.upstart: $(top_builddir)/config.status $(top_srcdir)/system/startup/monit.upstart.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
system/startup/monit.service: $(top_builddir)/config.status $(top_srcdir)/system/startup/monit.service.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
src/device/sysdep_LINUX.$(OBJEXT): src/device/$(am__dirstamp)
src/http/$(am__dirstamp):
	@$(MKDIR_P) src/http
	@: > src/http/$(am__dirstamp)
src/http/base64.$(OBJEXT): src/http/$(am__dirstamp)
src/http/cervlet.$(OBJEXT): src/http/$(am__dirstamp)
src/http/client.$(OBJEXT): src/http/$(am__dirstamp)
src/http/engine.$(OBJEXT): src/http/$(am__dirstamp)
src/http/xml.$(OBJEXT): src/http/$(am__dirstamp)
src/http/processor.$(OBJEXT): src/http/$(am__dirstamp)
src/notification/$(am__dirstamp):
	@$(MKDIR_P) src/notification
	@: > src/notification/$(am__dirstamp)
src/notification/Address.$(OBJEXT): src/notification/$(am__dirstamp)
src/notification/MMonit.$(OBJEXT): src/notification/$(am__dirstamp)
src/notification/SMTP.$(OBJEXT): src/notification/$(am__dirstamp)
src/process/$(am__dirstamp):
	@$(MKDIR_P) src/process
	@: > src/process/$(am__dirstamp)
src/process/ProcessTree.$(OBJEXT): src/process/$(am__dirstamp)
src/process/sysdep_LINUX.$(OBJEXT): src/process/$(am__dirstamp)
...
src/protocols/fail2ban.$(OBJEXT): src/protocols/$(am__dirstamp)
...
src/protocols/redis.$(OBJEXT): src/protocols/$(am__dirstamp)
src/protocols/rsync.$(OBJEXT): src/protocols/$(am__dirstamp)
src/protocols/sieve.$(OBJEXT): src/protocols/$(am__dirstamp)
src/protocols/sip.$(OBJEXT): src/protocols/$(am__dirstamp)
src/protocols/smtp.$(OBJEXT): src/protocols/$(am__dirstamp)
src/protocols/spamassassin.$(OBJEXT): src/protocols/$(am__dirstamp)
src/protocols/ssh.$(OBJEXT): src/protocols/$(am__dirstamp)
src/protocols/tns.$(OBJEXT): src/protocols/$(am__dirstamp)
src/protocols/websocket.$(OBJEXT): src/protocols/$(am__dirstamp)
src/ssl/$(am__dirstamp):
	@$(MKDIR_P) src/ssl
	@: > src/ssl/$(am__dirstamp)
src/ssl/Ssl.$(OBJEXT): src/ssl/$(am__dirstamp)
src/terminal/$(am__dirstamp):
	@$(MKDIR_P) src/terminal
	@: > src/terminal/$(am__dirstamp)
src/terminal/Box.$(OBJEXT): src/terminal/$(am__dirstamp)
src/terminal/Color.$(OBJEXT): src/terminal/$(am__dirstamp)

monit$(EXEEXT): $(monit_OBJECTS) $(monit_DEPENDENCIES) $(EXTRA_monit_DEPENDENCIES) 
	@rm -f monit$(EXEEXT)
	$(AM_V_CCLD)$(monit_LINK) $(monit_OBJECTS) $(monit_LDADD) $(LIBS)
...
mostlyclean-compile:
	...
	-rm -f src/notification/*.$(OBJEXT)
	-rm -f src/process/*.$(OBJEXT)
	-rm -f src/protocols/*.$(OBJEXT)
	-rm -f src/ssl/*.$(OBJEXT)
	-rm -f src/terminal/*.$(OBJEXT)
...
distclean-generic:
	...
	-rm -f src/notification/$(am__dirstamp)
	-rm -f src/process/$(am__dirstamp)
	-rm -f src/protocols/$(am__dirstamp)
	-rm -f src/ssl/$(am__dirstamp)
	-rm -f src/terminal/$(am__dirstamp)
